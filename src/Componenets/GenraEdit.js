...
function GenraEdit({data}) {
    ...
    const submitEdit=()=>{
      ...
      axios.put(`http://localhost:4000/admin/updateMovie/${data._id}`,formdata,{
        headers:{
          ...
          'token':'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJFbWFpbCI6IkFiaGlzaGVrM0BnbWFpbC5jb20iLCJpc0FkbWluIjp0cnVlLCJpYXQiOjE3MTEwMDY4OTcsImV4cCI6MTcxMTA5MzI5N30.tTB3ljq0S_TLstp3b6FmyZaVSMW6c3Al8RQmaL27grE'
        }
      }).then((res)=>{
  ...
  return (
    ...
    <input  className='form-control' type="text" onChange={(e)=>setIsSeries(e.target.value)}/> */}
